...
def drift_message(what: str, cost: str, *fixes: str) -> str:
    """A drift failure written for whoever tripped it: on a pull request the
    ci-infra maintainer who changed our code, and nightly whoever picks up the
    drift issue after vLLM moved under us.
